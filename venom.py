...
TOKEN = '7155454207:AAEStJD2FlP8c3LPvecJDRBooRVaW4tIjkU'
...
FORWARD_CHANNEL_ID = -1002237063154
CHANNEL_ID = -1002237063154
error_channel_id = -1002237063154
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/GODxBGMI_CHATGROUP/806*", parse_mode='Markdown')
